    ...
    <div class="card-body">
      ...
      <form action="<?php echo base_url('slider/update/' . $slider->id) ?> " method="POST" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="text" name="title" value="<?php echo $slider->title ?>" class="form-control" id="title" aria-describedby="emailHelp" placeholder="Nhập tên slider">
          <?php echo '<span class="text-danger">' . form_error('title') . '</span>' ?>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Mô tả</label>
          <input type="text" name="description" value="<?php echo $slider->description ?>" class="form-control" id="exampleInputPassword1" placeholder="Nhập mô tả">
        ...
        <div class="form-group">
          ...
          <img src="<?php echo base_url('uploads/slider/') . $slider->image ?>" width="100" height="100">
