  ...
  <div class="custom-container container">
    <div class="row">
      <div class="col-sm-12 padding-right">
                          ...
                          <div class="single-products <?php echo ($pro->quantity == 0) ? 'out-of-stock' : ''; ?>">
                            <div class="productinfo text-center">
                              ...
                              <div style="display:flex; flex-direction: column;">
                                ...
                                <button type="submit" class="btn btn-fefault cart" <?php echo ($pro->quantity == 0) ? 'disabled' : ''; ?>> <i class="fa fa-shopping-cart"></i>
                                  Thêm vào giỏ hàng
                                </button>
                              </div>
                            </div>
        ...
        <div
          style="flex:1;flex-grow:1;background-color:white;padding:20px;width:100%;margin-top:25px;margin-bottom:30px;border-radius:10px">
        </div>


        <div class="features_items">
          <div class="title-container">
            <h2 class="title">PC WORKSTATION</h2>
          </div>
          <div class="divTo">
            <div class="col-sm-3 shipping" style="padding:0;margin-right:20px">
              <img src="/frontend/images/3.png" alt="" />
            </div>
            <div id="featured-item-carousel" class="carousel slide  product-grid" data-ride="carousel"
              data-interval="false">
              <div class="carousel-inner">
                <?php $chunks = array_chunk($allproductPCWork_pagination, 8); ?>
                <?php foreach ($chunks as $key => $chunk) { ?>
                  <div class="item <?php echo $key == 0 ? 'active' : '' ?>">
                    <div class="row">
        ...
        <div class="features_items">
          ...
          <div class="divTo">
            ...
            <div id="featured-item-carousel" class="carousel slide  product-grid" data-ride="carousel"
              data-interval="false">
              <div class="carousel-inner">
                <?php $chunks = array_chunk($allproductpcMINI_pagination, 8); ?>
                <?php foreach ($chunks as $key => $chunk) { ?>
                  <div class="item <?php echo $key == 0 ? 'active' : '' ?>">
                    <div class="row">
                      <?php foreach ($chunk as $index => $pro) { ?>
        ...
        <div class="features_items">
          ...
          <div class="divTo">
            ...
            <div id="featured-item-carousel" class="carousel slide  product-grid" data-ride="carousel"
              data-interval="false">
              <div class="carousel-inner">
                <?php $chunks = array_chunk($allproductManHinh_pagination, 8); ?>
                <?php foreach ($chunks as $key => $chunk) { ?>
                  <div class="item <?php echo $key == 0 ? 'active' : '' ?>">
                    <div class="row">
                      <?php foreach ($chunk as $index => $pro) { ?>
